...
/// <summary>
/// Be aware this will not prevent a non singleton constructor such as `T myT = new T();` To prevent
/// that, add `protected T () {}` to your singleton class.
///
        ...
        public static T instance {
            get {
                if (applicationIsQuitting) {
                    DBG.Warning("[Singleton] Instance '" + typeof(T) +
                ...
                lock (_lock) {
                    if (_instance == null) {
                        ...
                        if (FindObjectsOfType(typeof(T)).Length > 1) {
                            DBG.Error("[Singleton] Something went really wrong " +
                        ...
                        if (_instance == null) {
                            ...
                            DBG.Log("[Singleton] An instance of " + typeof(T) +
                                " is needed in the scene, so '" + singleton +
                                "' was created with DontDestroyOnLoad.");
                        } else {
                            DBG.Log("[Singleton] Using instance already created: " +
